...
{
    public partial class RubricReport : Form
    {
        ...
        private void RubricReport_Load(object sender, EventArgs e)
        {
        ...
        private void RubricReport_Resize(object sender, EventArgs e)
        {
